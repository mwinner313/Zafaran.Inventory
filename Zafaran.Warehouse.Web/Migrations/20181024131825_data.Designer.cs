            ...
            modelBuilder.Entity("Zafaran.WareHouse.Core.Entities.Resturant", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CreatedOn = new DateTime(2018, 10, 24, 16, 48, 25, 218, DateTimeKind.Local), Title = "شعبه بلوار امین" },
                        new { Id = 2, CreatedOn = new DateTime(2018, 10, 24, 16, 48, 25, 220, DateTimeKind.Local), Title = "شعبه امام" }
                    );
                });
            ...
            modelBuilder.Entity("Zafaran.WareHouse.Core.Entities.Unit", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 2, CreatedOn = new DateTime(2018, 10, 24, 16, 48, 25, 221, DateTimeKind.Local), Title = "کیلو" },
                        new { Id = 1, CreatedOn = new DateTime(2018, 10, 24, 16, 48, 25, 221, DateTimeKind.Local), Title = "مثقال" },
                        new { Id = 4, CreatedOn = new DateTime(2018, 10, 24, 16, 48, 25, 221, DateTimeKind.Local), Title = "گرم" },
                        new { Id = 3, CreatedOn = new DateTime(2018, 10, 24, 16, 48, 25, 221, DateTimeKind.Local), Title = "تن" }
                    );
                });
