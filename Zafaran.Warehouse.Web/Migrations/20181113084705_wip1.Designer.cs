            ...
            modelBuilder.Entity("Zafaran.WareHouse.Core.Entities.Commodity", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, AvailableAmount = 100, Code = "123312312", CreatedOn = new DateTime(2018, 11, 13, 12, 17, 4, 769, DateTimeKind.Local), Title = "گوشت قرمز گوسفندی", UnitId = 1 },
                        new { Id = 2, AvailableAmount = 400, Code = "123312312", CreatedOn = new DateTime(2018, 11, 13, 12, 17, 4, 769, DateTimeKind.Local), Title = "برنج", UnitId = 4 },
                        new { Id = 3, AvailableAmount = 320, Code = "123312312", CreatedOn = new DateTime(2018, 11, 13, 12, 17, 4, 769, DateTimeKind.Local), Title = "رب گوجه", UnitId = 1 }
                    );
                });
            ...
            modelBuilder.Entity("Zafaran.WareHouse.Core.Entities.Resturant", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CreatedOn = new DateTime(2018, 11, 13, 12, 17, 4, 765, DateTimeKind.Local), Title = "شعبه بلوار امین" },
                        new { Id = 2, CreatedOn = new DateTime(2018, 11, 13, 12, 17, 4, 767, DateTimeKind.Local), Title = "شعبه امام" }
                    );
                });
            ...
            modelBuilder.Entity("Zafaran.WareHouse.Core.Entities.Unit", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 2, CreatedOn = new DateTime(2018, 11, 13, 12, 17, 4, 767, DateTimeKind.Local), Title = "کیلو" },
                        new { Id = 1, CreatedOn = new DateTime(2018, 11, 13, 12, 17, 4, 768, DateTimeKind.Local), Title = "مثقال" },
                        new { Id = 4, CreatedOn = new DateTime(2018, 11, 13, 12, 17, 4, 768, DateTimeKind.Local), Title = "گرم" },
                        new { Id = 3, CreatedOn = new DateTime(2018, 11, 13, 12, 17, 4, 768, DateTimeKind.Local), Title = "تن" }
                    );
                });
